...
if __name__ == '__main__':
    ...
    parser.add_argument('--example', type=int, default=0, help='if we have an example to segment an object')
    ...
    parser.add_argument('--ova_data_path', type=str, default= '/home/farhan/attMPTI/ova_data/blocks_bs1_s1', help= 'Directory to custom data')
    #optimization
    ...
    parser.add_argument('--n_episode_test', type=int, default=1,
                        help='Number of episode per configuration during testing') #I changed the default from 100 to 1, please not have to change it back
