...
DATASET='scannet'
SPLIT=0
DATA_PATH='/home/farhan/attMPTI/datasets/ScanNet/scenes/blocks_bs1_s1/'
...
PRETRAIN_CHECKPOINT='/home/farhan/attMPTI/scripts/log_scannet/log_mpti_scannet_S0_N2_K1_Att1log_pretrain_scannet_S0/'
N_WAY=2
K_SHOT=1
N_QUESIES=1
N_TEST_EPISODES=100
...
CUDA_VISIBLE_DEVICES=$GPU_ID python /home/farhan/attMPTI/main.py "${args[@]}"
