...
class ScanNetDataset(object):
    def __init__(self, cv_fold, data_path):
        self.data_path = data_path
        self.classes = 21

        class_names = open('/home/farhan/attMPTI/datasets/ScanNet/meta/scannet_classnames.txt').readlines()
        ...
        self.test_classes =  [self.type2class[i] for i in cv_fold]
